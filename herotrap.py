...
META_URL = 'https://raw.githubusercontent.com/Jcllynnaf/HeroTrap/master/metadata.json'
...
╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝ ╚═════╝    ╚═╝   ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝     
	...
	utils.print(f'{G}[>] {C}Created By   : {W}jcllynnaf')
	utils.print(f'{G} |---> {C}GitHub    : {W}{GitHub_url}')
	utils.print(f'{G} |---> {C}Instagram : {W}{Instagram_url}')
